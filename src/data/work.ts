...
export const meta = {
  ...
  description:
    "An archive of selected work from Tony Voorhees Studio, 2016 to 2026 — brand identity, motion direction, editorial sites, and print.",
};
...
export const FILTERS = ["All", "Product", "Branding", "Web", "Print"] as const;
